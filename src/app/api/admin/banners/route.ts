...
const BannerSchema = z.object({
  ...
  eyebrowColor: z.string().optional().nullable(),
  eyebrowSize: z.enum(["xs", "sm", "md"]).default("sm"),
  titleColor: z.string().optional().nullable(),
  titleSize: z.enum(["sm", "md", "lg", "xl", "2xl"]).default("lg"),
  subtitleColor: z.string().optional().nullable(),
  subtitleSize: z.enum(["xs", "sm", "md", "lg"]).default("md"),
