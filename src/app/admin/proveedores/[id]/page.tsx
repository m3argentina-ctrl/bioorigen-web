  ...
  return (
    <div className="p-6">
      ...
      <div className="grid max-w-5xl grid-cols-1 gap-6 lg:grid-cols-3">
        ...
        {/* Panel lateral: productos vinculados */}
        <div className="rounded-xl border border-slate-200 bg-white p-4 shadow-sm">
          <h3 className="mb-3 text-sm font-semibold text-slate-700">
            Productos vinculados ({supplier?.products.length ?? 0})
          </h3>
          {supplier?.products.length === 0 ? (
            <p className="text-xs text-slate-400">Ningún producto vinculado a este proveedor.</p>
          ) : (
          ...
          <p className="mt-4 text-xs text-slate-400">
            Para vincular un producto a este proveedor, editá el producto y asigná el proveedor en la sección de dropshipping.
          </p>
        </div>
      </div>
    </div>
